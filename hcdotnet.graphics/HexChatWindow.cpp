...
ResponseType HexChatWindow::MessageDialog(MessageType type, ButtonsType buttons, String^ format, ... array<String^>^ args) {
	GtkWidget* dlog = gtk_message_dialog_new(window,
	...
	gint result = gtk_dialog_run(GTK_DIALOG(dlog));
